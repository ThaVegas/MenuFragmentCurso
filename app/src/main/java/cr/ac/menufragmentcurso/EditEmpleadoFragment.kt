...
class EditEmpleadoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val textNombre = view.findViewById<TextView>(R.id.empleNombre)
        textNombre .setText(empleado?.nombre)
        val textCedula = view.findViewById<TextView>(R.id.empleCedula)
        textCedula.setText(empleado?.identificacion)
        val textPuesto = view.findViewById<TextView>(R.id.emplePuesto)
        textPuesto.setText(empleado?.puesto)
        val textDepartamento = view.findViewById<TextView>(R.id.empleDepartamento)
        ...
        view.findViewById<Button>(R.id.btnEdit).setOnClickListener {
            ...
            builder.setMessage("¿Desea modificar el usuario actual?")
                .setCancelable(false)
                .setPositiveButton("Sí"){dialog, id ->


                    empleado?.identificacion = textCedula.text.toString()
