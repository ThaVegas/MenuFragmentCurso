...
class MainActivity : AppCompatActivity(),NavigationView.OnNavigationItemSelectedListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var toolbar = findViewById<Toolbar>(R.id.toolbar)//Una variable que viene de la clase activity main, llamada toolbar
        ...
        toggle.syncState()//para sincronizar el estado
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when(item.itemId){
            R.id.nav_camera -> {
                fragment = fragment_Camera.newInstance(getString(R.string.menu_camera))
                title = R.string.menu_camera
            }
            R.id.nav_gallery -> {
                fragment = fragment_gallery.newInstance(getString(R.string.menu_gallery))
